...
* [Contents](work-with-devnet.md#contents)
* [Deploying your own Giver](work-with-devnet.md#deploying-your-own-giver)
  * [Generate Giver keys](work-with-devnet.md#generate-giver-keys)
  * [Compile Giver code](work-with-devnet.md#compile-giver-code)
  * [Calculate Giver address](work-with-devnet.md#calculate-giver-address)
  * [Sponsor Giver with public faucet](work-with-devnet.md#sponsor-giver-with-public-faucet)
  * [Deploy Giver contract](work-with-devnet.md#deploy-giver-contract)
* [Configure everdev to use your Giver](work-with-devnet.md#configure-everdev-to-use-your-giver)
* [Testing your new Giver](work-with-devnet.md#testing-your-new-giver)
...
You can find compiled giver v2 contract with code [here](https://github.com/tonlabs/evernode-se/tree/master/contracts/giver\_v2). You need to recompile code only if you want to change its code, so you can use compiled `GiverV2.tvc` file and move to the next step.

**Attention!** The code in repo is not compatible with the latest Solidity compilers, so if you would like to compile it yourself, you would need to migrate code to the latest Solidity version first.
