...
* [Everdev CLI](../../../../../../develop/sdk-tools/everdev-cli.md)
* [Solidity Compiler](../../../../../../develop/sdk-tools/command-line-interface/solidity-compiler.md)
* [Local Blockchain](../../../../../../develop/sdk-tools/command-line-interface/evernode-se.md)
* [Everscale Blockchain Explorer](https://ever.live)
* [GraphQL API](../../../../../../develop/sdk-tools/getting-started.md)
...
If you experience any problems with installation, check out our [troubleshooting section](../../../../../../develop/sdk-tools/everdev/troubleshooting.md).
...
:::caution Attention Docker should be running. :::
...
Set Local Blockchain [SE (Simple Emulator)](../../../../../../develop/sdk-tools/evernode-se.md) as the default network:
...
:::caution Attention! This giver is available only in SE. If you work in `DevNet` or `MainNet`, you need to deploy your own giver.

[**Check how to do it in this guide**](../../../../../../develop/sdk-tools/everdev/guides/work-with-devnet.md). :::
...
:::note Note That there are shortcuts for all the commands: `sl = signer list` and `sd = signer default` :)
...
1. If you want to migrate to Dev Network, read [Working with DevNet guide](../../../../../../develop/sdk-tools/everdev/guides/work-with-devnet.md).
...
3. If you want to integrate your application with Everscale - dive into our [SDK Quick Start](../../../../../../develop/sdk-tools/getting-started.md)!
