...
* [Stake and rounds](faq.md#stake-and-rounds)
* [Ensuring Regular Operations](faq.md#ensuring-regular-operations)
* [Rewards Distribution](faq.md#rewards-distribution)
...
Currently only one version of the DePool is used: the current [master](../../../depools/depools.md) version.
...
The contract code in open sourced and formally verified. See [specifications](../../../../learn/decentralization/depool-specifications.md) and contract [code](../../../depools/depools.md) for details.
...
The [DePool configuration](../../../depools/depools.md) will influence the appeal of your DePool to potential participants and its success in competition to the other DePools out there:
...
You have to follow this [procedure](../../../depools/depools.md) exactly. To briefly sum up, you have to do the following:
...
If all is set up correctly, DePool should participate in the next validator elections. If it doesn’t, [here](../../../depools/depools.md#troubleshooting) is some troubleshooting advice.
...
[Ordinary](../../../depools/depools.md#1-ordinary-stake), [vesting](../../../depools/depools.md#2-vesting-stake) and [lock](../../../depools/depools.md#3-lock-stake) stakes all have their own commands, that should be used to make a stake in the DePool, as they all have different sets of parameters, that need to be specified, when the stake is sent to the DePool.
...
* DePool is closed. Check [DePool events](../../../depools/depools.md#using-depool-events) to find out if it is.
...
Whenever an ordinary stake is made, it is set to be continuously reinvested. The participant who made the stake may [disable reinvestment](../../../depools/depools.md#reinvest-stakes) at any time, and the entirety of their ordinary stake will be withdrawn to their wallet as soon as the funds are unlocked from the rounds they are invested in.

A [part of the ordinary stake](../../../depools/depools.md#1-ordinary-stake) can also be withdrawn. The remainder of the stake will keep being reinvested in this case.

[Lock](../../../depools/depools.md#3-lock-stake) and [vesting](../../../depools/depools.md#2-vesting-stake) stakes are reinvested for the full duration of their existence, which is set during their investment.
...
If for any reason a value of 0.5 tokens proves to be insufficient (and DePool starts running out of gas trying to execute a transaction), it can be [increased in TONOS-CLI config](../../../depools/depools.md#7-configure-depool-state-update-method).
...
It can be done with the `getParticipantInfo` get-method. [Here's how.](../../../depools/depools.md#using-get-methods)
...
You can find some troubleshooting advice [here](../../../depools/depools.md#troubleshooting).
...
1. Once after the elections begin, so DePool gets ready to receive and forward validator's [election request](../../../depools/depools.md#3-validator-script-and-election-request-issues).
