...
We shall define transaction\_fee as a sum of all fees for a single transaction.
...
`gas_fees` — include all gas fees associated with the transaction. You can find more info in the [Gas calculation basics](../../../arch/02-managing-gas.md#gas-calculation-basics) section.
...
`trans.gas_fees` include all gas fees associated with the transaction. You can find more information in the [Gas calculation basics](../../../arch/02-managing-gas.md#gas-calculation-basics) section.
